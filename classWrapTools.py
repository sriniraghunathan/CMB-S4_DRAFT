...
########################################################
    ...
    #srini
    #cmd="cd " + classExecDir + " ; ./class " + classDataDir + 'input/' + rootName + ".ini"
    cmd="CLASS_delens/./class " + classDataDir + 'input/' + rootName + ".ini"
    print('\n\t\tExecuting CLASS with %s' %(cmd))
    os.system(cmd)
